...
# Purpose     : Save implementation results for the current SRCNN_42 build.
#
# Usage:
#   # From an already opened Vivado project:
#   source C:/DSD26_Termproject_Materials_260526/04_SRCNN_42/scripts/save_impl_snapshot.tcl
#
#   # Or from Vivado batch mode:
#   vivado -nolog -nojournal -notrace -mode batch \
#     -source ./04_SRCNN_42/scripts/save_impl_snapshot.tcl \
...
#   -tclargs --tag <name>      Output filename prefix. Default: SRCNN_42.
#   -tclargs --out <path>      Snapshot directory. Default: 04_SRCNN_42/impl_snapshot.
...
while {$arg_idx < $arg_count} {
    ...
    switch -- $arg {
        ...
        "--help" {
            puts "SRCNN_42 implementation snapshot"
            puts ""
            puts "Usage:"
            puts "  source ./04_SRCNN_42/scripts/save_impl_snapshot.tcl"
            puts ""
            ...
            puts "  --tag <name>      Output filename prefix. Default: SRCNN_42."
            puts "  --out <path>      Snapshot directory. Default: 04_SRCNN_42/impl_snapshot."
...
print_banner "SRCNN_42 implementation snapshot start"
...
print_banner "SRCNN_42 implementation snapshot complete"
