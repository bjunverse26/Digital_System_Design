...
# Purpose     : Save implementation results for the current SRCNN_88 build.
#
# Usage:
#   # From an already opened Vivado project:
#   source C:/DSD26_Termproject_Materials_260526/05_SRCNN_88/scripts/save_impl_snapshot.tcl
#
#   # Or from Vivado batch mode:
#   vivado -nolog -nojournal -notrace -mode batch \
#     -source ./05_SRCNN_88/scripts/save_impl_snapshot.tcl \
...
#   -tclargs --tag <name>      Output filename prefix. Default: SRCNN_88.
#   -tclargs --out <path>      Snapshot directory. Default: 05_SRCNN_88/impl_snapshot.
...
while {$arg_idx < $arg_count} {
    ...
    switch -- $arg {
        ...
        "--help" {
            puts "SRCNN_88 implementation snapshot"
            puts ""
            puts "Usage:"
            puts "  source ./05_SRCNN_88/scripts/save_impl_snapshot.tcl"
            puts ""
            ...
            puts "  --tag <name>      Output filename prefix. Default: SRCNN_88."
            puts "  --out <path>      Snapshot directory. Default: 05_SRCNN_88/impl_snapshot."
...
print_banner "SRCNN_88 implementation snapshot start"
...
print_banner "SRCNN_88 implementation snapshot complete"
