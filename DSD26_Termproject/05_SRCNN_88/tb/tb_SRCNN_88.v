...
module tb_SRCNN_88;
    ...
    reg [15:0] expected_layer2 [0:(8*IMG_PIXELS)-1];
    ...
    initial begin
        ...
        $readmemh("C:/DSD26_Termproject_Materials/05_SRCNN_88/ref/expected_output_1_2_3.txt",
                  expected_output);
        $readmemh("C:/DSD26_Termproject_Materials/05_SRCNN_88/ref/expected_layer1_test_1.txt",
                  expected_layer1);
        $readmemh("C:/DSD26_Termproject_Materials/05_SRCNN_88/ref/expected_layer2_test_1.txt",
                  expected_layer2);
        ...
        if (!i_rstn) begin
            ...
            if (o_done) begin
                ...
                if (done_count == NUM_IMAGES - 1) begin
                    ...
                    $display("[TB]");
                    $display("[TB]============================================================");
                    $display("[TB] SRCNN_88 TESTBENCH SUMMARY");
                    $display("[TB]============================================================");
