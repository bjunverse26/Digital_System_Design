...
// Author      : Beomjun Kim
// Description : DSP-based signed multiply-accumulate block.
// Notes       : The DSP C input receives the previous P output, creating an
//               accumulator while i_dsp_enable is asserted.
//==============================================================================
