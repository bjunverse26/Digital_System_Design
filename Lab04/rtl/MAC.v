...
// Author      : Beomjun Kim
// Description : DSP-based signed multiply-accumulate block used by GEMV designs.
// Notes       : The previous DSP result is registered as partial_sum and fed
//               back into the DSP C input.
//==============================================================================
