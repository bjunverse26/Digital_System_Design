//==============================================================================
// File Name   : controller_padding.v
// Project     : Digital System Design - Lab07
// Author      : Beomjun Kim
// Description : Read-control FSM for zero-padded 3x3 convolution top.
// Notes       : - Keeps the same state flow as controller.v.
//               - Reads all 3x3 kernel values first.
//               - Streams the first three padded input lines before convolution.
//               - Streams one additional padded line whenever the datapath
//                 completes one output row.
//               - Emits zero-valid pulses for padded border pixels.
//==============================================================================

`timescale 1ns / 1ps

module controller_padding #(
